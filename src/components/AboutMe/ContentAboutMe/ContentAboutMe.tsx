 ...
 */
export function ContentAboutMe({ year, text, children, timeLine }: ContentAboutMeProps): JSX.Element {
  return (
    <div className="flex justify-between text-sm lg:block">
      <p className="lg:text-base lg:mb-6 lg:font-bold">{year}</p>
      <div className="lg:flex lg:items-center">
        {children}
        {timeLine && <div className="bg-white m-auto w-0.5 h-full lg:w-full lg:h-0.5" />}
      </div>
