...
export const listTecnologies = [
  { tecnologie: 'Html', level: 'Especialista', sizeBar: FULL_BAR, id: 1 },
  { tecnologie: 'Javascript', level: 'Avançado', sizeBar: LARGER_BAR, id: 2 },
  { tecnologie: 'TypesScript', level: 'Avançado', sizeBar: LARGER_BAR, id: 3 },
  { tecnologie: 'React', level: 'Avançado', sizeBar: LARGER_BAR, id: 4 },
  { tecnologie: 'Redux', level: 'Avançado', sizeBar: LARGER_BAR, id: 5 },
  { tecnologie: 'NextJs', level: 'Avançado', sizeBar: LARGER_BAR, id: 6 },
  { tecnologie: 'CSS & Sass', level: 'Avançado', sizeBar: LARGER_BAR, id: 7 },
  { tecnologie: 'Tailwind', level: 'Avançado', sizeBar: LARGER_BAR, id: 8 },
  {
  ...
  { tecnologie: 'NodeJs', level: 'Básico', sizeBar: SMALL_BAR, id: 11 },
  { tecnologie: 'MongoDB', level: 'Básico', sizeBar: SMALL_BAR, id: 12 },
  { tecnologie: 'Vue', level: 'Básico', sizeBar: SMALL_BAR, id: 13 },
  { tecnologie: 'Angular', level: 'Básico', sizeBar: SMALL_BAR, id: 14 },
];
